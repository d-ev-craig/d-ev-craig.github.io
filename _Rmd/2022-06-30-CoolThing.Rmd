...
```{r}
seoulBike <- read_csv(file = "../d-ev-craig.github.io/_datasets/SeoulBikeData.csv", locale=locale(encoding="latin1"))
seoulBike <- seoulBike[ ,!(names(seoulBike) %in% c("Date"))]
...
```{r}
rmarkdown::render("C:/users/dcraig/Documents/Repos/d-ev-craig.github.io/_Rmd/2022-06-30-CoolThing.Rmd",output_format = md_document("markdown_github"), output_file = "2022-06-30-CoolThing",output_dir = "C:/users/dcraig/Documents/Repos/d-ev-craig.github.io/_posts", output_options = list(keep_html=FALSE))
```
